...
class DateItem extends PureComponent {
  render() {
    ...
    const normalBgColor = '#00122b';
    const hightlightTextColor = '#00122b';
...
class CalendarStrip extends Component {
  ...
  _renderHeader = () => {
    ...
    const dateFormatted_en = format(selectedDate, 'MMMM DD, YYYY');
  ...
  <Text style={styles.todayText}>{isChinese ? '_' : 'Today'}</Text>
          </TouchableOpacity>
        }
      </View>
    );
